...
function sumAndMultiply(a, b, c) {
   ...
   let mulA = multiply(a,b)[0];
   let mulB = multiply(mulA,c)[0];
   return[sumB,mulB,`${a} and ${b} and ${c} sum to ${sumB}.`,`The product of ${a} and ${b} and ${c} is ${mulB}.`];

}
//console.log(sumAndMultiply(2,4,7) ) ;
